    ...
    <div className="min-h-screen grid lg:grid-cols-2 grid-cols-1">
      ...
      <div className="flex flex-col items-center ">
        ...
        <div className="w-full max-w-md">
          <p className="font-semibold text-3xl mt-30">Sign up for GitHub</p>
          <button className="bg-gray-200 border-gray-300  mt-4 max-w-md w-full items-center justify-center py-2 flex flex-row rounded-lg hover:bg-gray-300">
          ...
          <div className="mt-2">
            ...
            <input
              type="email"
              className="max-w-md w-full border border-gray-500 py-2 rounded-lg "
            />
          </div>
          <div className="mt-2">
